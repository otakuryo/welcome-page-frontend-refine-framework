...
import { Form, Input, Switch, InputNumber, Upload, message } from "antd";
import type { CreateQuickLinkRequest } from "../../types/quicklinks";
import { UploadOutlined, LinkOutlined } from "@ant-design/icons";

export const QuickLinksCreate = () => {
  const { formProps, saveButtonProps } = useForm<CreateQuickLinkRequest>({
